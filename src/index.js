...
startButton.addEventListener("click", event => { knihovna.startReadingNextBook(); knihovna.listAllBooks(); });

let finishButton = document.getElementById("button--finish");
finishButton.addEventListener("click", event => { knihovna.finishCurrentBook(); knihovna.listAllBooks(); });